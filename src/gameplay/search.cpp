                ...
                else
                {
                    ...
                    while (!cells_to_visit.empty())
                    {
                        ...
                        else
                        {
                            ...
                            const engine::CardinalDirections neighbors = engine::get_directions(cell, t.size());
                            const engine::CardinalDirections neighbors2 = engine::get_directions_2(cell, t.size());
                            ...
                            if (neighbors.north)
                                cells_to_visit.push(*neighbors.north);

                            if (neighbors.east)
                                cells_to_visit.push(*neighbors.east);

                            if (neighbors.south)
                                cells_to_visit.push(*neighbors.south);

                            if (neighbors.west)
                                cells_to_visit.push(*neighbors.west);
                        }
                    }
